    ...
    "paths": {
        ...
        "/bills/ocr": {
            "post": {
                ...
                "description": "Process a bill image using OCR to extract bill data (placeholder - not yet implemented)",
                "consumes": [
                    "multipart/form-data"
                ],
                "produces": [
        ...
        "/bills/{id}/qr": {
            "get": {
                ...
                "description": "Generate a PromptPay QR code for the full bill amount to the bill creator",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/ws": {
            "get": {
                ...
                "description": "Establish a WebSocket connection for real-time messaging. The connection requires JWT authentication via query parameter or header.",
                "tags": [
                    "WebSocket"
                ],
...
var SwaggerInfo = &swag.Spec{
	...
	Title:            "PayNaiDee API",
	Description:      "PayNaiDee (เปย์ไหนดี) - Backend API service for expense sharing application with real-time chat, bill splitting, and QR code payment generation.",
